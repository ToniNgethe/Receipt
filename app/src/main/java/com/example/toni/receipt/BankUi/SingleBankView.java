...
public class SingleBankView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_bank_view);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        getSupportActionBar().setHomeAsUpIndicator(R.mipmap.ic_close_white_24dp);

        bankReceipts = (BankReceipts) getIntent().getSerializableExtra("RECEIPT");
    ...
    private void setupSnackBar(View view) {
        ...
        image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Global.isConnected(getApplication())) {
                    ...
                    Toast toast = Toast.makeText(SingleBankView.this, "", Toast.LENGTH_SHORT);
        ...
        pdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast t = Toast.makeText(SingleBankView.this,"Feature coming soon",Toast.LENGTH_SHORT);
    ...
    private void views() {
        ...
        coordinatorLayout = (CoordinatorLayout) findViewById(R.id.layout_bankreceipt);
        imageView = (ImageView) findViewById(R.id.iv_singlebank_image);
        _name = (TextView) findViewById(R.id.tv_banksingleview_name);
        _number = (TextView) findViewById(R.id.tv_banksingleview_number);
        _total = (TextView) findViewById(R.id.tv_banksingleview_total);
        _desc = (TextView) findViewById(R.id.tv_banksingleview_desc);
        _date = (TextView) findViewById(R.id.tv_banksingleview_date);
        _cat = (TextView) findViewById(R.id.tv_banksingleview_cat);
